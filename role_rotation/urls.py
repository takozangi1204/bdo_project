...
urlpatterns = [
    ...
    path('api/send-writer-reminder/', views.trigger_writer_reminder, name='role_rotation_trigger_writer_reminder'),
    path('api/send-writer-reminder/', views.trigger_writer_reminder, name='cadence_trigger_writer_reminder'),
